...
| `SERPAPI_API_KEY` | Recommended | Google SERP grounding ([serpapi.com](https://serpapi.com)) |
| `GEMINI_API_KEY` | Optional | Portfolio vision via Google API ([aistudio.google.com](https://aistudio.google.com/apikey)) |
...
Without `GEMINI_API_KEY`, portfolio brief uses OpenRouter Gemini Flash vision on sample job photos.
